...
from modeling_deberta import (
    DebertaV2ForMultipleChoice,
    DebertaV2ForMultipleChoiceCLISA,    # Transformer: 1 Layer
)
...
MODEL_CLASSES = {
    ...
    "deberta": (DebertaV2Config, DebertaV2ForMultipleChoiceCLISA, DebertaV2Tokenizer),
}
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False, test=False):
    ...
    all_soft_label_ids = torch.tensor([f.soft_label for f in features], dtype=torch.float) # (total, 4)
